...
export default function EmailTeamButton({ emailAddress = 'abousy-hero@hotmail.com', subject = 'Git in Touch' }) {
    const handleClick = () => {
    ...
    return (
        <div>
            ...
            <div onClick={handleClick} className='mt-20 z-20 font-bold w-[50%] h-20 arrow  ml-10 flex justify-start text-heading5 lg:text-heading4 lg:mt-20 lg:w-[50%] ' >
                ...
                <div className=' leading-6 lg:leading-8 cursor-pointer'>
                    ...
                    <span className=' uppercase text-left block tracking-tight'>team</span>
                </div>
