    ...
    return (
        <div className='relative'>
            <div>
                ...
                <h3 className=' absolute bottom-[-100px] text-left leading-7 uppercase text-heading5 tracking-tighter max-w-[400px] lg:text-heading2 lg:right-[-250px] lg:top-[450px] lg:leading-[0.85] lg:max-w-[700px]   '>{title}</h3>
