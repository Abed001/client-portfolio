...
export default function Quphb() {
    const comp = useRef(null);

    const quphbPageImages = [
        '/assets/quphb/QUPHB1.webp',
        '/assets/quphb/QUPHB2.webp',
        '/assets/quphb/QUPHB3.webp',
        '/assets/quphb/QUPHB4.webp',
    ];

    const project1Data = { imageSrc: quphbPageImages[0] };
    const project2Data = { imageSrc: quphbPageImages[1] };
    const project3Data = { imageSrc: quphbPageImages[2] };
    const project4Data = { imageSrc: quphbPageImages[3] };
            ...
            <Layout>
                <div ref={comp} className='relative overflow-hidden'>
                    ...
                    <div className='min-h-[100vh] flex flex-col items-center justify-center font-openSans font-bold text-white text-heading3 lg:text-heading1'>
                        ...
                        <motion.p id='text' className='hidden-on-phone absolute text-white text-heading font-bold lg:top-[70px] uppercase'>QUPHB</motion.p>
                        <img className='w-[100%] min-h-[100vh] object-cover object-center lg:mt-[400px]' src='/assets/quphb/QUPHB1.webp' alt="QUPHB project" loading='eager' />
                        ...
                        <MySlider images={quphbPageImages} />
