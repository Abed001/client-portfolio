...
export default function KioskProject() {
  ...
  const investPageImages = [
    "/assets/neon_kiosk/kiosk1.webp",
    "/assets/neon_kiosk/kiosk2.webp",
    "/assets/neon_kiosk/kiosk3.webp",
    "/assets/neon_kiosk/kiosk4.webp",
  ...
  const project1Data = {
    imageSrc: '/assets/neon_kiosk/kiosk8.webp',
  ...
  const project2Data = {
    imageSrc: '/assets/neon_kiosk/kiosk9.webp',
  ...
  const project4Data = {
    imageSrc: '/assets/neon_kiosk/kiosk11.webp',
    title: 'Exquisite lines define this space, its edges so sharp they take your breath away',
    description: 'This space is a theatrical echo of a bygone era, a place where the flamboyant.',
  };
  ...
  const project5Data = {
    imageSrc: '/assets/neon_kiosk/kiosk12.webp',
    title: 'Exquisite lines define this space, its edges so sharp they take your breath away',
    description: 'This space is a theatrical echo of a bygone era, a place where the flamboyant.',
  };

  const project6Data = {
    imageSrc: '/assets/neon_kiosk/kiosk2.webp',
