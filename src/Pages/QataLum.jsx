...
export default function QataLum() {
    const comp = useRef(null);

    const qatalumPageImages = [

        '/assets/qatalum/qatalum (11).webp',
        '/assets/qatalum/qatalum (12).webp',
        '/assets/qatalum/qatalum (13).webp',
        '/assets/qatalum/qatalum (15).webp',
        '/assets/qatalum/qatalum (16).webp',
        '/assets/qatalum/qatalum (17).webp',

    ];

    const project1Data = { imageSrc: qatalumPageImages[0] };
    const project2Data = { imageSrc: qatalumPageImages[1] };
    const project3Data = { imageSrc: qatalumPageImages[2] };
    const project4Data = { imageSrc: qatalumPageImages[3] };
    const project5Data = { imageSrc: qatalumPageImages[4] };
    const project6Data = { imageSrc: qatalumPageImages[5] };
            ...
            <Layout>
                <div ref={comp} className='relative overflow-hidden'>
                    ...
                    <div className='min-h-[100vh] flex flex-col items-center justify-center font-openSans font-bold text-white text-heading3 lg:text-heading1'>
                        ...
                        <motion.p id='text' className='hidden-on-phone absolute text-white text-heading font-bold lg:top-[70px] uppercase'>qatalum</motion.p>
                        <img className='w-[100%] min-h-[100vh] object-cover object-center lg:mt-[400px]' src='/assets/qatalum/qatalum (11).webp' alt="qatalum project" loading='eager' />
                        ...
                        <MySlider images={qatalumPageImages} />
