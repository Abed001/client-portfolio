...
export default function ExpoProject() {
  ...
  const investPageImages = [
    '/assets/qatar_expo/expo2.webp',
    '/assets/qatar_expo/expo3.webp',
    '/assets/qatar_expo/expo4.webp',
    '/assets/qatar_expo/expo5.webp',
    '/assets/qatar_expo/expo6.webp',
    '/assets/qatar_expo/expo7.webp',
    '/assets/qatar_expo/expo8.webp',
    '/assets/qatar_expo/expo9.webp',
    '/assets/qatar_expo/expo10.webp',
  ...
  const project1Data = {
    imageSrc:  '/assets/qatar_expo/expo2.webp',
  ...
  const project2Data = {
    imageSrc:  '/assets/qatar_expo/expo3.webp',
  ...
  const project3Data = {
    imageSrc:  '/assets/qatar_expo/expo4.webp',
  };


  const project4Data = {
    imageSrc:  '/assets/qatar_expo/expo5.webp',
    title: 'Exquisite lines define this space, its edges so sharp they take your breath away',
    description: 'This space is a theatrical echo of a bygone era, a place where the flamboyant.',
  };
  ...
  const project5Data = {
    imageSrc:  '/assets/qatar_expo/expo6.webp',
    title: 'Exquisite lines define this space, its edges so sharp they take your breath away',
    description: 'This space is a theatrical echo of a bygone era, a place where the flamboyant.',
  };

  const project6Data = {
    imageSrc:  '/assets/qatar_expo/expo7.webp',
