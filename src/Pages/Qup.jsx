...
export default function Qup() {
    const comp = useRef(null);

    const qupPageImages = [

        '/assets/qup/QUP (2).webp',
        '/assets/qup/QUP (3).webp',
        '/assets/qup/QUP (4).webp',
        '/assets/qup/QUP (5).webp',
        '/assets/qup/QUP (6).webp',
        '/assets/qup/QUP (7).webp',

    ];

    const project1Data = { imageSrc: qupPageImages[0] };
    const project2Data = { imageSrc: qupPageImages[1] };
    const project3Data = { imageSrc: qupPageImages[2] };
    const project4Data = { imageSrc: qupPageImages[3] };
    const project5Data = { imageSrc: qupPageImages[4] };
    const project6Data = { imageSrc: qupPageImages[5] };
            ...
            <Layout>
                <div ref={comp} className='relative overflow-hidden'>
                    ...
                    <div className='min-h-[100vh] flex flex-col items-center justify-center font-openSans font-bold text-white text-heading3 lg:text-heading1'>
                        ...
                        <motion.p id='text' className='hidden-on-phone absolute text-white text-heading font-bold lg:top-[70px] uppercase'>qup</motion.p>
                        <img className='w-[100%] min-h-[100vh] object-cover object-center lg:mt-[400px]' src='/assets/qup/QUP (3).webp' alt="qatalum project" loading='eager' />
