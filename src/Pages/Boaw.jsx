...
export default function BOAW() {
    const comp = useRef(null);

    const boawPageImages = [
        '/assets/boaw/BOAW1.webp',
        '/assets/boaw/BOAW2.webp',
        '/assets/boaw/BOAW3.webp',
        '/assets/boaw/BOAW4.webp',
        '/assets/boaw/BOAW5.webp',
        '/assets/boaw/BOAW6.webp',
        '/assets/boaw/BOAW7.webp',
    ];

    const project1Data = { imageSrc: boawPageImages[0] };
    const project2Data = { imageSrc: boawPageImages[1] };
    const project3Data = { imageSrc: boawPageImages[2] };
    const project4Data = { imageSrc: boawPageImages[3] };
    const project5Data = { imageSrc: boawPageImages[4] };
    const project6Data = { imageSrc: boawPageImages[5] };
    const project7Data = { imageSrc: boawPageImages[6] };
            ...
            <Layout>
                <div ref={comp} className='relative overflow-hidden'>
                    ...
                    <div className='min-h-[100vh] flex flex-col items-center justify-center font-openSans font-bold text-white text-heading3 lg:text-heading1'>
                        ...
                        <motion.p id='text' className='hidden-on-phone absolute text-white text-heading font-bold lg:top-[70px] uppercase'>BOAW</motion.p>
                        <img className='w-[100%] min-h-[100vh] object-cover object-center lg:mt-[400px]' src='/assets/boaw/BOAW1.webp' alt="BOAW project" loading='eager' />
                        ...
                        <div className="mb-60 p-5 lg:w-1/2">
                            <PortfolioItem {...project7Data} />
                        </div>
                        <MySlider images={boawPageImages} />
