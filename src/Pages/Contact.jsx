      ...
      <Layout>
        ...
        <main className='px-5 relative overflow-y-hidden overflow-x-hidden  text-white flex flex-col z-20 textleft leading-8  uppercase text-heading4 tracking-[-4px] lg:px-0 lg:tracking-[-10px] lg:text-heading1 lg:leading-[0.5] lg:w-full mt-40 lg:pl-0'>
          <CustomCursor
            ...
            targetOpacity={0.5}
          />
          <h1 className='text-[3.7rem] lg:mt-20 lg:text-[10rem]'> <span className='lg:ml-[370px]'>DIVULGE</span>
            <div className='p-0 m-0 flex justify-left items-center'><span>IN DESIGN </span> <span className='ml-[-20px] hidden-on-phone'><IoCloseSharp name="close" size={180} /></span>
              <span className='ml-[-10px] lg:hidden md:hidden'><IoCloseSharp name="close" size={80} /></span></div>
            DECADENCE</h1>
          ...
          <div className='tracking-normal font-bold text-white w-[100%] flex flex-col justify-center items-start'>
            <div className='pl-3 w-[80%] flex justify-between'>
              <span className='leading-tight max-w-[80px] uppercase text-smallpara mt-4 ml-[-] lg:text-para lg:ml-10'>we are based in</span>
