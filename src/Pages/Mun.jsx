...
export default function QataLum() {
    ...
    const munPageImages = [
        ...
        '/assets/mun/mun1.webp',
        '/assets/mun/mun2.webp',
        '/assets/mun/mun3.webp',
        '/assets/mun/mun4.webp',
        '/assets/mun/mun5.webp',

    ];

    const project1Data = { imageSrc: munPageImages[0] };
    const project2Data = { imageSrc: munPageImages[1] };
    const project3Data = { imageSrc: munPageImages[2] };
    const project4Data = { imageSrc: munPageImages[3] };
    const project5Data = { imageSrc: munPageImages[4] };
    const project6Data = { imageSrc: munPageImages[2] };
            ...
            <Layout>
                <div ref={comp} className='relative overflow-hidden'>
                    ...
                    <div className='min-h-[100vh] flex flex-col items-center justify-center font-openSans font-bold text-white text-heading3 lg:text-heading1'>
                        ...
                        <motion.p id='text' className='hidden-on-phone absolute text-white text-heading font-bold lg:top-[70px] uppercase'>mun</motion.p>
                        <img className='w-[100%] min-h-[100vh] object-cover object-center lg:mt-[400px]' src='/assets/mun/mun1.webp' alt="mun project" loading='eager' />
